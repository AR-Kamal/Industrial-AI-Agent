...
env = environ.Env(
    ...
    GEMINI_API_KEY=(str, ""),
    GROUNDED_MAX_QUESTION_CHARS=(int, 4000),
    GROUNDED_MAX_EVIDENCE_CHARS=(int, 18000),
...
LLM_STRUCTURED_OUTPUT = env("LLM_STRUCTURED_OUTPUT")
GEMINI_API_KEY = env("GEMINI_API_KEY")
GROUNDED_MAX_QUESTION_CHARS = env("GROUNDED_MAX_QUESTION_CHARS")
GROUNDED_MAX_EVIDENCE_CHARS = env("GROUNDED_MAX_EVIDENCE_CHARS")
